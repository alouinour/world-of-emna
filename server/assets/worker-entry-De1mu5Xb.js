...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DJDyu_VP.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-B91IfP88.js").then((n2) => n2.r),
...
var ROUTER_BASEPATH = "world-of-emna";
var SERVER_FN_BASE = "/world-of-emna/_serverFn/";
